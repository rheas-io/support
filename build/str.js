...
class Str {
     ...
     * @param encoding
     */
    static base64Decode(data, encoding = 'utf8') {
     ...
     * @param excludeKeys
     */
    static queryString(params, excludeKeys = []) {
     ...
     * @param size
     */
    static async random(size = 16) {
        return await new Promise((resolve, reject) => {
            crypto_1.default.randomBytes(size, (error, buffer) => {
                if (error !== null) {
     ...
     * @param replace
     */
    static replace(str, needle, replace) {
     ...
     * @param replace
     */
    static replaceWithOne(str, needle) {
        needle = Str.escapeForRegex(needle);
